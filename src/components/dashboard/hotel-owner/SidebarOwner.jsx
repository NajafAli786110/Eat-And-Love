...
const SidebarOwner = ({ activeTab, setActiveTab }) => {
  const menuItems = [
    ...
    },
    {
      text: "Add Inventory",
      icon: <BiHistory />,
      activeComponent: "Add-Inventory",
    },
    {
      text: "Attendence Management",
      icon: <BiHistory />,
      activeComponent: "Attendence-Management",
    },
    {
      text: "Profile",
      icon: <BiHistory />,
      activeComponent: "Profile-owner",
    },
  ];
  return (
    <Box
